...
import { HelpCircle, Briefcase, AlertTriangle, CheckCircle } from 'lucide-react';
...
export const InterviewPrep = () => {
  ...
  const interviewQuestions = [
    ...
    },
    {
      ...
      a: "close() closes only the current browser window focused by WebDriver. quit() closes all browser windows opened by WebDriver and ends the WebDriver session."
    },
    {
      q: "What are the different types of waits in Selenium?",
      a: "Implicit Wait (global timeout for finding elements), Explicit Wait (condition-specific wait using WebDriverWait), and Fluent Wait (explicit wait with custom polling interval and exception handling)."
    },
    {
      q: "How do you handle dynamic elements?",
      a: "Use partial attribute matching with contains(), starts-with(), or ends-with() in XPath. Use CSS selectors with partial matches. Implement explicit waits. Use relative locators based on stable parent elements."
    },
    {
    ...
    },
    {
      ...
      a: "findElement() returns a single WebElement and throws NoSuchElementException if not found. findElements() returns a List<WebElement> and returns an empty list if no elements found."
    },
    {
      q: "How do you handle frames in Selenium?",
      a: "Use driver.switchTo().frame() with index, name/ID, or WebElement. To return to main content, use defaultContent(). For nested frames, switch to each frame sequentially."
    },
    {
    ...
    },
    {
      ...
      a: "Use driver.switchTo().alert() to get Alert object. Methods: accept() (OK), dismiss() (Cancel), getText() (get message), sendKeys() (for prompts)."
    },
    {
      q: "What is the Actions class used for?",
      a: "Actions class handles complex user interactions: mouse hover, drag and drop, right-click, double-click, keyboard actions (Ctrl+A, Ctrl+C), and chained actions."
    }
  ];
  ...
  const projectExplanation = [
    ...
    },
    {
      ...
      content: "The framework has a clear separation: src/main has base classes, page objects, utilities, and configurations. src/test contains test classes organized by application module. We use properties files for environment configuration."
    },
    {
      title: "Key Features",
  ...
  const challenges = [
    {
      ...
      solution: "Implemented retry logic with re-fetching of elements. Used explicit waits before interactions. Created wrapper methods that handle staleness automatically."
    },
    {
    ...
    },
    {
      ...
      solution: "Replaced Thread.sleep with explicit waits. Created custom wait conditions for complex scenarios. Implemented fluent waits with custom polling for AJAX-heavy pages."
    },
    {
      problem: "Cross-Browser Compatibility",
      solution: "Used WebDriverManager for automatic driver management. Created browser-specific configuration. Implemented conditional logic for browser-specific behaviors."
    },
    {
      problem: "Parallel Execution Failures",
      solution: "Used ThreadLocal for WebDriver instances. Ensured test independence with proper setup/teardown. Isolated test data to prevent conflicts."
    }
  ];
    ...
    <section id={section.id} className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-2xl font-semibold text-foreground">Common Selenium Interview Questions</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-2xl font-semibold text-foreground">How to Explain This Project in Interview</h3>
        </div>
        ...
        <div className="p-5 bg-card rounded-xl border border-border">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            The framework is built using Java, Selenium WebDriver, TestNG, and Maven. I implemented the Page Object Model 
            ...
            WebDriver instances for thread safety. The framework has been used to automate regression suites for our 
            e-commerce and booking applications, reducing manual testing effort by 60%."
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-2xl font-semibold text-foreground">How This Framework is Used in Real Companies</h3>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-5 bg-card rounded-xl border border-border">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li>• Triggered on every code push</li>
          ...
          <div className="p-5 bg-card rounded-xl border border-border">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• Smoke tests: Every deployment</li>
              <li>• Sanity tests: After fixes</li>
              <li>• Regression: Nightly/Weekly</li>
      ...
      <div className="p-6 bg-gradient-to-br from-section-interview/20 to-transparent rounded-xl border border-section-interview/30">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li>✅ Explain your debugging approach</li>
          ...
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li>✅ Know the difference between theoretical and practical</li>
